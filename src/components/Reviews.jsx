...
const StarRating = ({ count }) => (
  <div className="review__stars">
    {Array.from({ length: count }).map((_, i) => (
      <svg key={i} width="14" height="14" viewBox="0 0 24 24" fill="#F6AD55">
  ...
  return (
    <section className="reviews" ref={ref}>
      <div className="reviews__bg">
        <div className="reviews__bg-blob"></div>
      </div>
      ...
      <div className="container">
        ...
        <div className="reviews__grid">
          {reviews.map((r, i) => (
            <div
              key={i}
              className={`reviews__card ${visible ? 'reviews__card--visible' : ''}`}
            ...
            >
              <div className="reviews__card-top">
                ...
                <div className="reviews__quote-icon">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" style={{ color: r.color, opacity: 0.3 }}>
              ...
              <div className="reviews__verified">
                <svg width="12" height="12" viewBox="0 0 24 24" fill="#38A169"><path d="M22 11.08V12C22 17.52 17.52 22 12 22S2 17.52 2 12 6.48 2 12 2c1.88 0 3.64.52 5.14 1.42" stroke="#38A169" strokeWidth="2"/><polyline points="22 4 12 14.01 9 11.01" stroke="#38A169" strokeWidth="2"/></svg>
                Verified User
              </div>
            </div>
          ))}
